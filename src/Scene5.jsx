...
export default function Scene5(props) {

    const group = useRef()
    const { nodes, materials, scene, animations } = useGLTF('/vehicule/evo/scene.gltf')
...
useGLTF.preload('../public/vehicule/evo/scene.gltf')
